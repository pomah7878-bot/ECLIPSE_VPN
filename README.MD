...
Telegram-бот для автоматизации VPN-бизнеса на базе 3x-UI. Приём оплаты, выдача подписок, личный кабинет на сайте (Google/Яндекс/VK), AI-консультант.

Это независимый проект (второй бизнес), развёрнутый на собственной кодовой базе.
