...
async def main():
    ...
    background_tasks = [daily_tasks, update_tasks, traffic_tasks, payment_check_tasks, anonymous_payment_check_tasks, channel_posts_tasks, duplicate_detection_tasks, webapp_task]
